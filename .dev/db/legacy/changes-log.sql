-- УСТАРЕЛО. История изменений схемы по версию 0.26.0; файл больше не пополняется.
-- Начиная с 0.27.0 изменения схемы оформляются миграциями — см.
-- docs/db-migrations.md и соседний README.md. Нужен только для обновления
-- установки старее 0.26.0 до этой версии.
