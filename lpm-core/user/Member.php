...
class Member extends User
{
	public static function loadListByInstance($instanceType, $instanceId,
			$onlyNotLocked = false, $leftJoinTable = null, $class = null) {
	...
	public static function loadListByIssue($issueId, $onlyNotLocked = false) {
		return self::loadListByInstance(LPMInstanceTypes::ISSUE, $issueId, false,
			LPMTables::ISSUE_MEMBER_INFO, 'IssueMember');
	}
