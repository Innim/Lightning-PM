 ...
 *
 * Таск подписывает свой хук только на события пайплайнов: влития и пуши
 * приносит системный хук инстанса, а системными хуками события пайплайнов
 * не отдаются вообще. Наборы событий не пересекаются намеренно - иначе одно
 * событие приходило бы дважды, двумя разными хуками.
 *
...
{
    /**
     * Набор событий, на которые подписывается хук таска.
     *
