...
class IssueTestChecklistBuilder
{
    ...
    const SUBSTATUS_NOTES = [
        IssueSubstatus::BACKLOG => 'задача ещё в работе и не поставлена на доску',
        IssueSubstatus::TODO => 'задача ещё в работе, к ней не приступали',
        IssueSubstatus::IN_PROGRESS => 'задача ещё в работе, в тест не отправлена',
